        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {products.map((p) => (
                ...
                >
                    ...
                    <p className="text-gray-600 text-sm mb-2">{p.description.substring(0, 25)}...</p>
                    ...
                    <div className="mt-4 flex gap-2">
                        <button className="flex-1 bg-gray-500 text-white text-sm py-2 rounded" onClick={() => navigate(`/product/${p.slug}`)}>More Details</button>
